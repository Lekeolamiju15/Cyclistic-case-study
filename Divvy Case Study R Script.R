### Cyclistic Case Study Google Data Analytics Captone Project ###
...
setwd("C:/Users/DELL/Desktop/DIVVY/CAPSTONE")
...
write.csv(counts, file = ("C:/Users/DELL/Desktop/DIVVY/CAPSTONE/avg_ride_length.csv"))
...
all_trips_v2 %>%
  ...
  summarise(number_of_rides = n()
            ,average_duration = mean(ride_length)) %>% 
  arrange(MonthName,member_casual)  %>% 
